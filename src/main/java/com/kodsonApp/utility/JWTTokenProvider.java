...
public class JWTTokenProvider {
    ...
    public String generateJwtToken(KodsonPrincipal restaurantPrincipal){
        String[] claims = getClaimsFromUser(restaurantPrincipal);
        return JWT.create().withIssuer(SecurityConstant.KODSON_LLC).withAudience(SecurityConstant.RESTAURANT_ADMINISTRATION)
    ...
    private String[] getClaimsFromUser(KodsonPrincipal restaurantPrincipal) {
